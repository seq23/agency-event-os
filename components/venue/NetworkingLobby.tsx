  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_0.8fr]">
      ...
      <section className="rounded-3xl bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-slate-600">Join the queue for timed 1:1 conversations. You can skip, report, or return to the lobby at any time. Joining records a networking analytics event for post-event reporting.</p>
      </section>
