  ...
  return (
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-md rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-slate-950">Forgot password</h1>
        <p className="mt-2 text-slate-600">Mock password reset shell. Email delivery is deferred.</p>
