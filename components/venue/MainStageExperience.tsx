    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_24rem]">
        <section className="rounded-3xl bg-slate-950 p-6 text-white shadow-sm">
          ...
          <div className="mt-6 flex aspect-video items-center justify-center rounded-3xl border border-white/10 bg-slate-900 p-6 text-center text-slate-400">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.25em] text-cyan-300">White-label main stage video</p>
              <p className="mt-3 text-lg text-white">LiveKit primary with Daily fallback and Zoom / Google Meet manual backup.</p>
            </div>
          </div>
        </section>
