...
const required = ['LiveKit','Daily','Zoom','Google Meet','CrewAccess-2026!','SpeakerGuest-2026!','SponsorGuest-2026!','VIPGuest-2026!','Operator Launchpad','Production Gate','Preview Demo Venue','Create First Event','Testing Console','run-of-show spine','Setup spine','Access spine','Venue spine','Fallback spine','Communications spine'];
